...
namespace laboratorio_02_tarea_03
{
    internal class Program
    {
        ...
        static void AgregarEncuesta()
        {
            ...
            {
                Console.WriteLine("No se pueden agregar más encuestas.");
                return;
            }

            Console.WriteLine("Ingrese los datos de la encuesta (7 características):");
            for (int i = 0; i < 7; i++)
            {
                Console.Write($"Característica {i + 1}: ");
                Encuesta[indiceEncuesta, i] = Console.ReadLine();
            }
            indiceEncuesta++;
            Console.WriteLine("Encuesta agregada correctamente.");
        }
        ...
        {
            if (indicePregunta >= Pregunta.GetLength(0))
            {
                Console.WriteLine("No se pueden agregar más preguntas.");
                return;
            }

            Console.WriteLine("Ingrese los datos de la pregunta (7 características):");
            for (int i = 0; i < 7; i++)
            {
                Console.Write($"Característica {i + 1}: ");
                Pregunta[indicePregunta, i] = Console.ReadLine();
            }
            indicePregunta++;
        ...
        {
            if (indiceRespuesta >= Respuesta.GetLength(0))
            {
                Console.WriteLine("No se pueden agregar más respuestas.");
                return;
            }

            Console.WriteLine("Ingrese los datos de la respuesta (7 características):");
            for (int i = 0; i < 7; i++)
            {
                Console.Write($"Característica {i + 1}: ");
                Respuesta[indiceRespuesta, i] = Console.ReadLine();
            }
            indiceRespuesta++;
            Console.WriteLine("Respuesta agregada correctamente.");
        }
        ...
        static void VerRespuestas()
        {
            ...
            for (int i = 0; i < indiceRespuesta; i++)
            {
                Console.WriteLine($"\nRespuesta #{i + 1}:");
                for (int j = 0; j < 7; j++)
                {
